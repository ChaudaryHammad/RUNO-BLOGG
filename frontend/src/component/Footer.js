...
const Footer = () => {
  return (
    ...
    <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-2 sm:px-6 lg:px-2 lg:pt-2">
      <div className="text-center">
        <h2 className="text-3xl font-extrabold text-gray-900 sm:text-5xl">Start writting today</h2>
